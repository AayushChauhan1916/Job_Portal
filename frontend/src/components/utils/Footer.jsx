      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex flex-col md:flex-row justify-between mb-8">
          ...
          <div className="mb-8 md:mb-0">
            ...
            <p className="text-gray-400">Email: <a href="mailto:aayushchauhan1916@gmail.com" className="text-blue-400 hover:underline">aayushchauhan1916@gmail.com</a></p>
            <p className="text-gray-400">Phone: <a href="tel:+91 7060457474" className="text-blue-400 hover:underline">+91 7060457474</a></p>
          </div>
          ...
          <div className="flex items-center justify-center md:justify-start gap-4">
            <a href="https://github.com/AayushChauhan1916" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-500">
            ...
            <a href="https://www.instagram.com/nishkarsh.rajput/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-pink-500">
