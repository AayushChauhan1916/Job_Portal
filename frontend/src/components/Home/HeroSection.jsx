  ...
  return (
    <div className="text-center">
      <div className="flex flex-col gap-5 my-10">
        ...
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Alias labore omnis error praesentium, earum quas!</p>
        <div className="flex lg:w-[40%] md:w-[60%] sm:w-full shadow-lg border-gray-200 pl-3 rounded-full items-center gap-4 mx-auto">
            <input type="text" onChange={(e)=>setQuery(e.target.value)} className="outline-none border-none w-full"  placeholder="Find Your Dream Jobs"/>
